...
public class UserManagementServiceApplication {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("PRAVEEN NAGA SPRING BOOT SWAGGER")
				.description("WELCOME TO SWAGGER CLIENT")
				.contact(new Contact("PRAVEEN NAGA", "https://praveennagatech.blogspot.com/",
						"opraveennaga@gmail.com"))
